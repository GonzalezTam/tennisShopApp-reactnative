...
const Auth = ({ navigation }) => {
  ...
  const title = isLogin ? 'Log in to your account' : 'Register now';
  const message = isLogin ? "Don't you have an account?" : 'Already have an account?';
  const messageAction = isLogin ? 'Log in' : 'Register';
